...
namespace CarCareTracker.Helper
{
    ...
    public class TranslationHelper : ITranslationHelper
    {
        ...
        public string Translate(string userLanguage, string text)
        {
            ...
            var translationFilePath = userLanguage == "en_US" ? _fileHelper.GetFullFilePath($"/defaults/en_US.json") : $"{StaticHelper.TranslationFilePath}{userLanguage}.json";
        ...
        public OperationResponse SaveTranslation(string userLanguage, Dictionary<string, string> translations)
        {
            ...
            var translationFilePath = isDefaultLanguage ? _fileHelper.GetFullFilePath($"/defaults/en_US.json") : $"{StaticHelper.TranslationFilePath}{userLanguage}.json";
            try
            {
                if (File.Exists(translationFilePath))
                {
