namespace CarCareTracker.Models
{
    public class KioskVehicleViewModel
    {
        ...
        public string MostCommonServiceRecord { get; set; }
        ...
        public string MostExpensiveServiceRecord { get; set; }
        ...
        public string MostCommonRepairRecord { get; set; }
        ...
        public string MostExpensiveRepairRecord { get; set; }
        ...
        public string MostCommonUpgradeRecord { get; set; }
        ...
        public string MostExpensiveUpgradeRecord { get; set; }
